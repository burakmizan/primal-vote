...
export const STAT_BACKGROUND_MAP: Record<StatKey, BackgroundKey> = {
  heat: 'bg_volcanic',
  cold: 'bg_tundra',
  speed: 'bg_savanna',
  armor: 'bg_cave',
...
export const STREAK_FLAIRS: FlairDefinition[] = [
...
export const CRISIS_FLAIR: FlairDefinition = {
  id: 'crisis_survivor',
  label: '⚔️ Crisis Survivor',
};

export const VETERAN_FLAIR: FlairDefinition = {
  id: 'veteran',
  label: '🔰 Veteran',
};
