...
export type BackgroundKey = 'bg_volcanic' | 'bg_tundra' | 'bg_savanna' | 'bg_cave' | 'bg_mystic' | 'bg_aqua';
export type MutationCategory = 'physical' | 'cognitive' | 'adaptive';
export type AnimationState = 'idle' | 'happy' | 'anxious' | 'crisis' | 'hurt' | 'devastated' | 'transforming' | 'battle_scar';
...
export type AdminAction = {
    ...
    type: 'LOAD_SEED_STATE';
    seedDay?: number;
} | {
    type: 'SET_VOTE_WINDOW';
    hours: number;
};
